...
export default function ProjectSettingsPage() {
  ...
  return (
    <div style={{ padding: "32px 40px", width: "100%", display: "flex", gap: 32 }}>
      {/* Sidebar Nav */}
        ...
        {activeSection === "danger" && (
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              <div style={{ background: "white", border: "1.5px solid #FCA5A5", borderRadius: 14, padding: "20px 24px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <div>
